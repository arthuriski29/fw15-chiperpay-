...
import { HiArrowRight, HiLockClosed, HiOutlineArrowUp, HiPlus, HiUser } from 'react-icons/hi';
        ...
        <div className='flex flex-col w-[80%] justify-between rounded-2xl shadow-2xl mr-20 px-10 py-10 gap-6 bg-[#f5f5f5] text-black'>
          ...
          <form className='flex flex-col h-[70%] items-center gap-8 text-black'>
            <div className='flex items-center w-[450px]'>
              <IoCallOutline className="absolute ml-2 text-[#9CA3AF]" alt="Email Icon" />
              <div className="absolute ml-8 text-black font-bold">+62</div>
              <input className='input border-0 border-b-2 border-[#9CA3AF] rounded-none flex-1 w-full pl-20 bg-[#f5f5f5]' type='number' name='phoneNumber' placeholder='Enter Your Phone Number' />
            </div>
            <button className='btn btn-secondary w-[450px]' type="submit"> Edit Phone Number</button>
          </form>
        </div>
      </div>
