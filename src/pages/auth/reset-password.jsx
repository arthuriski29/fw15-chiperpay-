...
const validationSchema = Yup.object({
  password: Yup.string().min(4, 'Password min 4 characters').required('Password is required'),
                  ...
                  <form onSubmit={handleSubmit} className='flex flex-col gap-4'autoComplete="off">
                    ...
                    <div className='flex flex-col justify-center gap-6'>
                      ...
                      <div className='relative flex items-center'>
                        ...
                        />
                        <button type='button' onClick={handleConfirmPassword} className='absolute bottom-4 right-4 text-[#9CA3AF]'>
                            {iconEye ? (
                                <i className=''>
                                    <FiEye size={15} />
                                </i>
