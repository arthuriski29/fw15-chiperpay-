      ...
      <div className="w-full">
        <section className="relative overflow-hidden h-[100vh] bg-accent">
          ...
          <div className="relative flex justify-between items-center h-[10vh] mx-[7%]">
            <Link
              href="/"
              className="font-extrabold text-[45px] text-base-100 text-xl"
            >
          ...
          <div className="flex mx-[10%] h-[80%] items-center">
            ...
            <div className="flex-1">
              <div className="mt-[520px]">
                <Image src={phone1} alt="phone-1" width="600" height="1155" />
              </div>
            </div>
          </div>
        </section>
        <section className="h-[27vh] w-full bg-[#E2D3C5]">
          <div className="flex h-full justify-between mx-[10%]">
            <Image src={partners1} alt="partners-1" width="173" height="120" />
            <Image src={partners2} alt="partners-1" width="173" height="120" />
            <Image src={partners3} alt="partners-1" width="173" height="120" />
            <Image src={partners4} alt="partners-1" width="173" height="120" />
          </div>
        </section>
        <section className="h-[100vh] flex flex-col gap-20 text-black py-[100px] px-[200px]">
          <div className="flex flex-col justify-center items-center mt-[40px] gap-8 text-center">
            <div className="font-bold text-[75px]">
              <span className="text-[#F59376]">About</span> the Application.
            </div>
            <div className="font-normal text-[22px] px-[100px] leading-10">
              We have some great features from the application and it&rsquo;s
          ...
          <div className="flex justify-between items-center gap-6">
            <div className="rounded-lg bg-[#F5F5F5] border-solid drop-shadow-2xl flex flex-col items-center justify-center py-12 px-8 gap-8 text-center">
              ...
              <div className="text-[24px] font-extrabold leading-[31px]">
                24/7 Support
              </div>
              <div className="font-normal size-[18px] leading-[31px]">
        ...
        <section className="h-[120vh] bg-[#E2D3C5] flex overflow-hidden">
          <div className="w-[40%] flex flex-col justify-between my-[-350px] items-end">
            <Image src={phone2} alt="phone-2" width="469" height="892" />
            <Image src={phone2} alt="phone-2" width="469" height="892" />
          </div>
            ...
            <div className="flex flex-col gap-8 mr-[25%]">
              <div className="flex flex-col border-solid rounded-xl bg-[#f5f5f5] text-black shadow-lg py-6 px-4 gap-4">
                <div className="font-extrabold">
                  <span className="text-[#F59376]">1.</span> Small Fee
                </div>
                <div className="font-normal size-[18px] leading-[31px]">
              ...
              <div className="flex flex-col border-solid rounded-xl bg-[#f5f5f5] text-black shadow-lg py-6 px-4 gap-4">
                <div className="font-extrabold">
                  <span className="text-[#F59376]">2.</span> Data Secured
                </div>
                <div className="font-normal size-[18px] leading-[31px]">
              ...
              <div className="flex flex-col border-solid rounded-xl bg-[#f5f5f5] text-black shadow-lg py-6 px-4 gap-4">
                <div className="font-extrabold">
                  <span className="text-[#F59376]">3.</span> User Friendly
                </div>
                <div className="font-normal size-[18px] leading-[31px]">
                  chiperPay come up with modern and sleek design and not
                  complicated.
                </div>
              </div>
            </div>
        ...
        <section className="h-[100vh] flex flex-col justify-center items-center bg-[#f5f5f5] text-black gap-10">
          <div className="flex flex-col gap-8 items-center">
            <div className="font-bold text-[75px] leading-[93px] text-center">
              What Users are <span className="text-[#F59376]">Saying.</span>
            </div>
            <div className="font-semibold size-[18px] leading-[31px] w-[65%] text-center">
              We have some great features from the application and it&rsquo;s
              totally free to use by all users around the world.
            </div>
          </div>
          <div className="w-[60%] py-[60px] px-[40px] flex flex-col items-center border-solid shadow-xl rounded-2xl gap-4 text-center bg-white">
            <div className="rounded-full overflow-hidden">
              <Image src={profile2} alt="profile-2" width="120" height="120" />
            </div>
            <div className="font-bold size-[25px] leading-[40px]">
              Alex Hansinburg
            </div>
            <div className="font-normal size-[20px] leading-[33px]">
              Designer
            </div>
            <div className="font-normal size-[18px] leading-[33px]">
              “This is the most outstanding app that I&rsquo;ve ever try in my
              live, this app is such an amazing masterpiece and it&rsquo;s
              suitable for you who is bussy with their bussiness and must
              transfer money to another person aut there. Just try this app and
              see the power!”
            </div>
          </div>
        </section>
